...
<div class="container my-5">
  <div class="row">
        ...
        <div class="card elevation-orange border-0 rounded-4 p-3">
            ...
            <div class="d-flex text-dark p-2 bg-primary rounded">
              ...
              <p class="fw-bold fs-4 mb-0">USD ${{ editable?.cost?.price }}</p>
              <p class="mb-0 ms-2">
  ...
  <section>
    <div class="container my-5">
        ...
        <div class="col-md-6">
          <div class="">
            <h1 class="display-3 font-2">{{editable?.location?.address }}</h1>
          </div>
          <div class="">
            <p class="fs-4 text-start">{{ editable?.location?.description }}</p>
          </div>
        </div>
  ...
  <div class="container my-5">
       <div class="row ">
          <div class="col-md-5">
            ...
            <div class="">
              <p class="fs-4 text-start">{{ editable?.food?.description }}</p>
            </div>
          </div>
