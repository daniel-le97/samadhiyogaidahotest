<template>
  <div class="">
    ...
    <div class="heroImage d-flex flex-column align-items-center justify-content-center">
      ...
      <div class="w-75">
        <p v-motion-slide-bottom class="text-light px-5 text-start fs-3 text-shadow px-5">
          ...
          Physical and mental wellbeing are of utmost importance to living a healthy life and require practice and
          dedication. Our
          Small Business provides the setting and guidance you need to strengthen your body, mind and soul. All you have
          to do is
          show up and breathe.
        </p>
      </div>
      ...
      <div class="row mt-5 px-3">
        <div class="col-md-6 elevation-6">
          <img
            ...
            alt="" class="img-fluid framed my-5 ms-5 ">
        </div>
        <div class="col-md-6">
          <p class="display-3"> Katy Alverson</p>
