...
2. Clone the repo
   ```sh
   git clone https://github.com/TungLe0319/samadhiyogaidaho.git
   ```
...
See the [open issues](https://github.com/TungLe0319/samadhiyogaidaho/issues) for a full list of proposed features (and known issues).
...
Your Name - [linkedin-shield]([linkedin-url]) 
